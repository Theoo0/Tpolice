...
RegisterNetEvent('Tpolice:debutservice')
AddEventHandler('Tpolice:debutservice', function()
	local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	sendToDiscordWithSpecialURL("Centrale",xPlayer.getName().." a pris son service", 16744192, Config.Webhook)
end)

RegisterNetEvent('Tpolice:finservice')
AddEventHandler('Tpolice:finservice', function()
	local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	sendToDiscordWithSpecialURL("Centrale",xPlayer.getName().." a quitté son service", 16744192, Config.Webhook)
end)

RegisterNetEvent('Tpolice:chiensortis')
AddEventHandler('Tpolice:chiensortis', function()
	local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	sendToDiscordWithSpecialURL("Centrale",xPlayer.getName().." a sortis son chien", 16744192, Config.Webhook)
end)

RegisterNetEvent('Tpolice:chienrentre')
AddEventHandler('Tpolice:chienrentre', function()
	local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	sendToDiscordWithSpecialURL("Centrale",xPlayer.getName().." a rentré son chien", 16744192, Config.Webhook)
end)

RegisterNetEvent('Tpolice:boucliersortis')
AddEventHandler('Tpolice:boucliersortis', function()
	local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	sendToDiscordWithSpecialURL("Centrale",xPlayer.getName().." a sortis son bouclier", 16744192, Config.Webhook)
end)

RegisterNetEvent('Tpolice:bouclierranger')
AddEventHandler('Tpolice:bouclierranger', function()
	local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	sendToDiscordWithSpecialURL("Centrale",xPlayer.getName().." a ranger son bouclier", 16744192, Config.Webhook)
end)

RegisterNetEvent('Tpolice:retirervoiture')
AddEventHandler('Tpolice:retirervoiture', function()
	local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	sendToDiscordWithSpecialURL("Centrale",xPlayer.getName().." a retirer un permis voiture", 16744192, Config.Webhook)
end)
...
RegisterNetEvent('Tpolice:retirercamion')
AddEventHandler('Tpolice:retirercamion', function()
	local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	sendToDiscordWithSpecialURL("Centrale",xPlayer.getName().."a retirer un permis camion", 16744192, Config.Webhook)
end)

RegisterNetEvent('Tpolice:retirermoto')
AddEventHandler('Tpolice:retirermoto', function()
	local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	sendToDiscordWithSpecialURL("Centrale",xPlayer.getName().." a retirer un permis moto", 16744192, Config.Webhook)
end)

RegisterNetEvent('Tpolice:retirerppa')
AddEventHandler('Tpolice:retirerppa', function()
	local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	sendToDiscordWithSpecialURL("Centrale",xPlayer.getName().." a retirer un ppa", 16744192, Config.Webhook)
end)

RegisterNetEvent('Tpolice:petitedemanderenfort')
AddEventHandler('Tpolice:petitedemanderenfort', function()
	local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	sendToDiscordWithSpecialURL("Centrale",xPlayer.getName().." a fait un appel au central", 16744192, Config.Webhook)
end)

RegisterNetEvent('Tpolice:moyennedemanderenfort')
AddEventHandler('Tpolice:moyennedemanderenfort', function()
	local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	sendToDiscordWithSpecialURL("Centrale",xPlayer.getName().." a demandé du renfort", 16744192, Config.Webhook)
end)

RegisterNetEvent('Tpolice:code99')
AddEventHandler('Tpolice:code99', function()
	local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	sendToDiscordWithSpecialURL("Centrale",xPlayer.getName().." a fait un code 99", 16744192, Config.Webhook)
end)
...
ESX.RegisterServerCallback('Tpolice:getStockItems', function(source, cb)
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_police', function(inventory)
		cb(inventory.items)
	end)
end)

RegisterNetEvent('Tpolice:getStockItem')
AddEventHandler('Tpolice:getStockItem', function(itemName, count)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
ESX.RegisterServerCallback('Tpolice:getPlayerInventory', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
	local items   = xPlayer.inventory
...
RegisterNetEvent('Tpolice:putStockItems')
AddEventHandler('Tpolice:putStockItems', function(itemName, count)
	local xPlayer = ESX.GetPlayerFromId(source)
	local sourceItem = xPlayer.getInventoryItem(itemName)
